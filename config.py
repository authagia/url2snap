...
YTDLP_BIN = os.environ.get("AUDIO_SOURCE_YTDLP_BIN", "yt-dlp")
YTDLP_METADATA_TIMEOUT = float(os.environ.get("AUDIO_SOURCE_YTDLP_METADATA_TIMEOUT", "20"))
METADATA_WORKERS = int(os.environ.get("AUDIO_SOURCE_METADATA_WORKERS", "2"))
METADATA_ERROR_COOLDOWN = float(os.environ.get("AUDIO_SOURCE_METADATA_ERROR_COOLDOWN", "30"))
